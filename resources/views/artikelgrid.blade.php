                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Archive by Category ARTIKEL</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="archive-catagory-view mb-50 d-flex align-items-center justify-content-between">
                        ...
                        <div class="archive-catagory">
                            <h4><i class="fa fa-book" aria-hidden="true"></i> Artikel</h4>
                        </div>
                        <!-- View Options -->
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single-post-area mb-50">
                            ...
                            <div class="post-thumbnail">
                                <img src="../../{{$item->gambar_artikel}}" alt="" style="height:200px">
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <a href="#" class="post-cata cata-sm cata-success">{{$item->kategori->nama_kategori}}</a>
                                <a href="{{route('detailArtikel', $id = $item->id)}}" class="post-title">{{$item->judul_artikel}}</a>
                                <div class="post-meta d-flex">
                                    <a href="#"> By {{$item->user->name}}</a>
                                    <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> {{$item->views}}</a>
                                    <a href="#"><i class="post-date" aria-hidden="true"></i> {{$item->created_at}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
