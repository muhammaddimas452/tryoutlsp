                                ...
                                <form action="{{ route('updateArtikel', $id = $artikel->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" class="form-control" value="{{$artikel->judul_artikel}}" name="judul_artikel" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group-inner">
                                                ...
                                                <div class="file-upload-inner ts-forms">
                                                    <div class="input prepend-small-btn">
                                                        ...
                                                        <div class="file-button">
                                                            Browse
                                                            <input type="file" value="" name="gambar_artikel" onchange="document.getElementById('prepend-small-btn').value = this.value;">
                                                        </div>
                                                        <input type="text" value="{{$artikel->gambar_artikel}}" id="prepend-small-btn" placeholder="no file selected">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
