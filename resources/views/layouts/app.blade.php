                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="/admin/data-artikel"><span class="mini-sub-pro">Data Artikel</span></a></li>
                                <li><a title="All Professors" href="/admin/data-kategori"><span class="mini-sub-pro">Data Kategori</span></a></li>
                            </ul>
                        </li>
                        <li class="">
